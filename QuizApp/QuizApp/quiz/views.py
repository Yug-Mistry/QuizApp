...
class QuizDetailView(DetailView):
    model = Quiz
    slug_field = 'url'
    template_name = 'Quiz/QuizDetails.html'
...
class QuizMarkingList(QuizMarkerMixin, SittingFilterTitleMixin, ListView):
    model = Sitting
    template_name = 'Quiz/ListOfCompleteExam.html'
...
class QuizMarkingDetail(QuizMarkerMixin, DetailView):
    model = Sitting
    template_name = 'Quiz/CompleteQuiz.html'

    def post(self, request, *args, **kwargs):
        sitting = self.get_object()

        q_to_toggle = request.POST.get('pk', None)
        if q_to_toggle:
...
class QuizTake(FormView):
    ...
    result_template_name = 'Quiz/QuizResult.html'
    single_complete_template_name = 'Quiz/SingleComplete.html'
...
def pending_question(request):
    ...
    return render(request, 'Quiz/AddQuiz.html', {'quiz_list': quizList})
